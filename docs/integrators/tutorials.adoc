...
the sample scenarios. If you think of information we will need to provide
for PR1 and it is missing from this skeleton, please send an email to
ipaas-dev to suggest what needs to be added. 
