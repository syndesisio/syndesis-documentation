...
.. In the *Sources* panel, scroll down to the *user* field, expand
it and click the *name* field. (The ability to search directly for the *name* field is expected to be 
