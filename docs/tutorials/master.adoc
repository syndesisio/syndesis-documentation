...
Explore the {prodname} Technology Preview by creating a
sample integration. See the instructions in <<twitter-to-salesforce>>. 

In this Technology Preview release, exactly one integration at a time can 
