...
Explore the {prodname} Technology Preview by creating 
sample integrations. The main tasks are:

. <<register-with-applications>>
. <<create-connections>>
. <<create-sample-integrations>>

include::topics/register_with_applications.adoc[leveloffset=+1]

include::topics/create_connections.adoc[leveloffset=+1]

include::topics/create_sample_integrations.adoc[leveloffset=+1]
